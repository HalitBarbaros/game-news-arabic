...
<head>
    ...
    <style>
        ...
        /* --- NINJA GOOGLE HIDING CSS --- */
        
        /* 1. Hide the Google Icon */
        ...
        .goog-te-gadget-simple:hover { background-color: var(--accent) !important; border-color: var(--accent) !important; }
        
        /* 3. Hide 'Powered by Google' text */
        .goog-te-gadget { font-size: 0px !important; color: transparent !important; }
        
        /* 4. Style the Language Text itself */
        ...
        .goog-te-gadget-simple:hover .goog-te-menu-value span:first-child { color: #000 !important; }

        /* 5. Hide the vertical pipes | and arrows */
        .goog-te-menu-value span:nth-child(n+2) { display: none !important; }

        /* 6. KILL THE TOP BANNER FRAME */
        .goog-te-banner-frame { display: none !important; visibility: hidden !important; }
        body { top: 0px !important; }

        /* 7. Hide Tooltips on Hover */
...
# ... (Manifest and SW remain correct)
manifest_content = """{
  "name": "Game News",
  "short_name": "GameNews",
  "start_url": ".",
...
print("✅ Visual Clean-up: Google Branding Removed & Banner Hidden")
